...
export function UiPopover(props: {
  ...
  return (
    <div ref={state.attachRef} class={classMerge("relative", props.class)}>
      ...
      <div
        ...
        hidden={!props.open}
        class={classMerge(
          "absolute top-[calc(100%+0.5rem)] z-40 w-72 rounded-card border border-border-strong bg-surface p-space-5 text-content shadow-2xl shadow-black/60",
