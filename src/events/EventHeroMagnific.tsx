...
export function EventHeroMagnific(props: { eventCount?: number }) {
  ...
  return (
    <section
      class="relative w-full overflow-hidden bg-[#0a0d24] bg-gradient-to-b from-[#0f143a] via-[#1a1744] to-[#070919] px-5 py-16 text-white sm:px-10 lg:px-20 2xl:px-40"
    ...
    >
          ...
          <div class="relative flex h-[420px] items-center justify-center">
            ...
            <div class="relative flex w-full max-w-lg items-center gap-6">
              ...
              <div class="flex shrink-0 items-center justify-center" aria-hidden="true">
                <svg width="28" height="28" viewBox="0 0 24 24" class="size-7 fill-brand text-brand" aria-hidden="true">
                  <polygon points="4,2 22,12 4,22" fill="currentColor" />
                </svg>
              </div>

              {/* Overflow-hidden window of height 420px */}
              <div class="h-[420px] w-full overflow-hidden" aria-live="off">
                <div
      ...
      <div class="relative mx-auto mt-16 max-w-screen-2xl border-t border-white/10 pt-10">
